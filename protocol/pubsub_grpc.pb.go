...
const (
	PubsubService_Publish_FullMethodName = "/protocol.PubsubService/Publish"
	PubsubService_Consume_FullMethodName = "/protocol.PubsubService/Consume"
)
...
type PubsubServiceClient interface {
	Publish(ctx context.Context, in *PublishArgs, opts ...grpc.CallOption) (*PublishReply, error)
	Consume(ctx context.Context, in *ConsumeArgs, opts ...grpc.CallOption) (PubsubService_ConsumeClient, error)
}
...
func (c *pubsubServiceClient) Publish(ctx context.Context, in *PublishArgs, opts ...grpc.CallOption) (*PublishReply, error) {
...
func (c *pubsubServiceClient) Consume(ctx context.Context, in *ConsumeArgs, opts ...grpc.CallOption) (PubsubService_ConsumeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PubsubService_ServiceDesc.Streams[0], PubsubService_Consume_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *pubsubServiceConsumeClient) Recv() (*ConsumeReply, error) {
	m := new(ConsumeReply)
...
type PubsubServiceServer interface {
	Publish(context.Context, *PublishArgs) (*PublishReply, error)
	Consume(*ConsumeArgs, PubsubService_ConsumeServer) error
...
func (UnimplementedPubsubServiceServer) Publish(context.Context, *PublishArgs) (*PublishReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Publish not implemented")
}
func (UnimplementedPubsubServiceServer) Consume(*ConsumeArgs, PubsubService_ConsumeServer) error {
...
func _PubsubService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PubsubServiceServer).Publish(ctx, req.(*PublishArgs))
	}
...
func _PubsubService_Consume_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PubsubServiceServer).Consume(m, &pubsubServiceConsumeServer{stream})
}

type PubsubService_ConsumeServer interface {
	Send(*ConsumeReply) error
	grpc.ServerStream
}
...
func (x *pubsubServiceConsumeServer) Send(m *ConsumeReply) error {
...
var PubsubService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protocol.PubsubService",
